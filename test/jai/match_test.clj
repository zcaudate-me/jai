...
^{:refer jai.match/p-fn :added "0.1"}
...
^{:refer jai.match/p-is :added "0.1"}
...
^{:refer jai.match/p-equal :added "0.1"}
...
^{:refer jai.match/p-pattern :added "0.1"}
...
^{:refer jai.match/p-or :added "0.1"}
...
^{:refer jai.match/p-parent :added "0.1"}
...
^{:refer jai.match/p-child :added "0.1"}
...
^{:refer jai.match/p-first :added "0.1"}
...
^{:refer jai.match/p-last :added "0.1"}
...
^{:refer jai.match/p-nth :added "0.1"}
(fact "checks that the last element of the container has a certain characteristic"
...
^{:refer jai.match/p-nth-left :added "0.1"}
(fact "checks that the last element of the container has a certain characteristic"
...
^{:refer jai.match/p-nth-right :added "0.1"}
(fact "checks that the last element of the container has a certain characteristic"
...
^{:refer jai.match/p-contains :added "0.1"}
...
^{:refer jai.match/p-ancestor :added "0.1"}
...
^{:refer jai.match/p-sibling :added "0.1"}
...
^{:refer jai.match/p-left :added "0.1"}
...
^{:refer jai.match/p-right :added "0.1"}
...
^{:refer jai.match/p-left-of :added "0.1"}
...
^{:refer jai.match/p-right-of :added "0.1"}
...
^{:refer jai.match/p-left-most :added "0.1"}
(fact "checks that any element on the right has a certain characteristic"
...
^{:refer jai.match/p-right-most :added "0.1"}
(fact "checks that any element on the right has a certain characteristic"
